; UnistallLog NSIS Extension by Rookie12
...
;CreateShortcut macro
  !macro CreateShortcut ShortcutPath FilePointer
    FileWrite $UninstLog "${ShortcutPath}$\r$\n"
    CreateShortcut "${ShortcutPath}" "${FilePointer}"
  !macroend
